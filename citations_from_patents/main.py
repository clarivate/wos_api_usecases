...
SEARCH_QUERY = 'OG=University of New South Wales Sydney and PY=1800-1999'


# A request to Expanded API to calculate the total number of records
# and total number of requests required to retrieve them
...
# Launching the function above for every document record that was
